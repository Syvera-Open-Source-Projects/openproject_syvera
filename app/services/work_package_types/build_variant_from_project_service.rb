...
module WorkPackageTypes
  ...
  class BuildVariantFromProjectService < ::BaseServices::BaseCallable
    ...
    # Reads the join table directly rather than through `all_work_package_custom_fields`, which
    # stops consulting it once the feature is on — and the feature is always on when this runs.
