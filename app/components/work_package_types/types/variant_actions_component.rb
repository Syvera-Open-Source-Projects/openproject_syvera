    ...
    class VariantActionsComponent < ApplicationComponent
      ...
      def configure_action(menu)
        menu.with_item(
          ...
          href: helpers.scoped_variant_path(:edit_type_details_path, type_id: variant.type_id, variant_id: variant.id)
        ) do |item|
      ...
      def delete_action(menu)
        menu.with_item(
          ...
          scheme: :danger,
          href: helpers.scoped_variant_path(:type_variant_path, type_id: variant.type_id, id: variant.id),
